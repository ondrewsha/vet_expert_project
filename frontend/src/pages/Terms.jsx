  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="prose prose-emerald max-w-none bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100">
        ...
        <p>
          Настоящее Соглашение определяет условия использования сервиса «ЗооМедика» (далее — «Сервис»). Используя Сервис, Вы подтверждаете, что прочитали, поняли и согласны с условиями данного документа.
        </p>
        ...
        <ul className="space-y-2">
          ...
          <li><strong>Цифровые товары (Гайды):</strong> После оплаты цифрового руководства пользователь получает бессрочный доступ к скачиванию файла из своего личного кабинета. В связи с природой цифровых товаров, возврат средств за них не производится.</li>
        </ul>
